...
public abstract class AAlligatorStrategy extends AStrategy implements Cloneable, IStrategyShort {
    ...
    public boolean isBuyMaxOnlySmaDown() { return false; }
    ...
    public boolean isFractalInDayTimeTrading() { return false; }
    ...
    public Integer getTrendUpLengthOnSell() { return getTrendUpLength(); }
    ...
    public boolean isStopLossOnDownByLimitAndAllMinLines() { return false; }
    public boolean isStopLossByLimitAndAllMinLines() { return false; }
    ...
    public boolean isMinProfitPercent() { return true; }
    ...
    public Double getBuyProfitPercentK() { return null; }
    public Double getLimitPercentByNextMaxK() { return null; }
